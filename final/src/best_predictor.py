...
class BestPredictor(BasePredictor):
    ...
    def __init__(self, embedding,
        ...
        self.model = Best(embedding.size(1),
    ...
    def _run_iter(self, batch, training):
        with torch.no_grad():
            ...
            context = torch.cat( (self.embedding(batch['context'].to(self.device)),
                self.embedding(batch['speaker'].to(self.device))), 2)
